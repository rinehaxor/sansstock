...
const $$New = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "AdminLayout", $$AdminLayout, { "title": "Kategori Baru", "email": email }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8"> <!-- Header --> <div class="mb-8"> <div class="flex items-center justify-between"> <div> <h1 class="text-3xl font-bold text-gray-900">Buat Kategori Baru</h1> <p class="mt-2 text-sm text-gray-600">Isi form di bawah untuk membuat kategori baru</p> </div> <a href="/dashboard/categories" class="text-sm text-gray-600 hover:text-gray-900">
...
Deskripsi
</label> <textarea id="description" name="description" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Deskripsi singkat tentang kategori ini (opsional)"></textarea> </div> <!-- Actions --> <div class="flex items-center justify-end gap-4 pt-6 border-t border-gray-200"> <a href="/dashboard/categories" class="px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
Batal
...
Simpan Kategori
</button> </div> </form> </div> ${renderScript($$result2, "D:/ProjekGabut/sansstocks/sansstocks/src/pages/dashboard/categories/new.astro?astro&type=script&index=0&lang.ts")} ` })}`;
}, "D:/ProjekGabut/sansstocks/sansstocks/src/pages/dashboard/categories/new.astro", void 0);

const $$file = "D:/ProjekGabut/sansstocks/sansstocks/src/pages/dashboard/categories/new.astro";
const $$url = "/dashboard/categories/new";
