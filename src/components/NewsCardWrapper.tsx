         ...
         <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
            <a href={articleUrl} className="flex-shrink-0 w-full sm:w-48">
               {thumbnail_url ? (
                  <img
                     ...
                     className="w-full sm:w-48 h-48 sm:h-28 rounded-lg object-cover"
                     loading="lazy"
                     width={192}
                     height={112}
                     decoding="async"
            ...
            <div className="flex-1 min-w-0">
               <a href={articleUrl} className="block">
                  ...
                  <p className="text-sm text-gray-600 mb-3 line-clamp-2 sm:line-clamp-2">{summary || 'Tidak ada ringkasan tersedia...'}</p>
               </a>
